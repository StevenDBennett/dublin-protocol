#ifndef GPU_QUANTUM_WORKING_CU
#define GPU_QUANTUM_WORKING_CU
...
struct ComplexDouble {
    ...
    __host__ __device__ ComplexDouble() : real(0.0), imag(0.0) {}
    __host__ __device__ ComplexDouble(double r, double i) : real(r), imag(i) {}

    __host__ __device__ ComplexDouble operator+(const ComplexDouble& other) const {
    ...
    __host__ __device__ ComplexDouble operator*(double scalar) const {
